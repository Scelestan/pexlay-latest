function C() { var choice = "Planifier une exploration ensemble pour en savoir plus#Mission en équipe*Garder ce secret pour eux seuls#Secret partagé";var texting = `
<br/>
**Alliance renforcée**
<br/>
<br/>
En révélant ses découvertes à Chloé, Xalendan renforce leur confiance mutuelle. Ils décident de planifier une exploration discrète pour en apprendre davantage sur cette mystérieuse énergie et pour voir si d’autres secrets peuvent être découverts dans les environs du château.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}IV7").click();}