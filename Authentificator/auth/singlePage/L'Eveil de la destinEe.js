function C() { var choice = "Revenir au prEsent avec cette connaissance#Retour au château*Embrasser le changement#Rester dans la vision pour en apprendre plus#HEritage des fondateurs";var texting = `
<br/>
**L'Eveil de la destinEe**
<br/>
<br/>
Xalendan se rEveille de sa vision, chargE de cette connaissance interdite. En retournant au château, il sait que dEsormais, rien ne sera plus comme avant. Mais il porte en lui un nouvel objectif, une destinEe qui pourrait changer l'avenir de l'ordre.
<br/>
<br/>
