function C() { var choice = "Planifier une exploration ensemble pour en savoir plus#Mission en Equipe*Garder ce secret pour eux seuls#Secret partagE";var texting = `
<br/>
**Alliance renforcEe**
<br/>
<br/>
En rEvElant ses dEcouvertes à ChloE, Xalendan renforce leur confiance mutuelle. Ils dEcident de planifier une exploration discrète pour en apprendre davantage sur cette mystErieuse Energie et pour voir si d’autres secrets peuvent être dEcouverts dans les environs du château.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}"DIV7").click();}