function C() { var choice = "Déchiffrer un passage compliqué pour en comprendre le sens#Texte décodé*Utiliser une incantation ancienne pour révéler des secrets cachés#Révélation mystérieuse";var texting = `
<br/>
**Savoir caché**
<br/>
<br/>
Parmi les écrits anciens, ils trouvent un passage codé qui semble protéger un secret. Xalendan et Chloé se concentrent sur chaque mot, cherchant à révéler des vérités cachées depuis des générations. Ils ressentent qu'ils sont proches de percer un mystère essentiel.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}ocument.getElementById("DIV7").click();}