function C() { var choice = "DEchiffrer un passage compliquE pour en comprendre le sens#Texte dEcodE*Utiliser une incantation ancienne pour rEvEler des secrets cachEs#REvElation mystErieuse";var texting = `
<br/>
**Savoir cachE**
<br/>
<br/>
Parmi les Ecrits anciens, ils trouvent un passage codE qui semble protEger un secret. Xalendan et ChloE se concentrent sur chaque mot, cherchant à rEvEler des vEritEs cachEes depuis des gEnErations. Ils ressentent qu'ils sont proches de percer un mystère essentiel.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();} "page1");document.getElementById("DIV7").click();}