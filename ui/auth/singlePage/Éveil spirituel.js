function C() { var choice = "Utiliser cet éveil pour renforcer son mental#Clarté nouvelle*Se lever et reprendre son chemin dans le feu#Oui je suis là";var texting = `
<br/>
**Éveil spirituel**
<br/>
<br/>
Selestan trouve une clarté nouvelle en lui, une vision de sa mission et de sa force. Ce moment d’éveil lui donne l’énergie de continuer, sentant que le feu a révélé en lui des aspects cachés de son être.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}harge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}