function C() { var choice = "Utiliser cet Eveil pour renforcer son mental#ClartE nouvelle*Se lever et reprendre son chemin dans le feu#Oui je suis là";var texting = `
<br/>
**Eveil spirituel**
<br/>
<br/>
Selestan trouve une clartE nouvelle en lui, une vision de sa mission et de sa force. Ce moment d’Eveil lui donne l’Energie de continuer, sentant que le feu a rEvElE en lui des aspects cachEs de son être.
<br/>
<br/>
...
ok.autoZoom(false);
charge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}rge.autoRedimention(false, "page1");document.getElementById("DIV7").click();}